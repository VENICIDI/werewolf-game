...
const svgs = {
  wolf: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M4 2L7 6L6 9L4 11L6 13L5 16L8 15L10 18L12 16L14 18L16 15L19 16L18 13L20 11L18 9L17 6L20 2L16 5L12 3L8 5L4 2Z" fill="${color}" opacity="0.25"/><path d="M4 2L7 6L6 9L4 11L6 13L5 16L8 15L10 18L12 16L14 18L16 15L19 16L18 13L20 11L18 9L17 6L20 2L16 5L12 3L8 5L4 2Z" stroke="${color}" stroke-width="1.5" stroke-linejoin="round"/><path d="M9.5 9.5L10.5 10.5" stroke="${color}" stroke-width="1.8" stroke-linecap="round"/><path d="M13.5 9.5L14.5 10.5" stroke="${color}" stroke-width="1.8" stroke-linecap="round"/><path d="M10 13L12 14.5L14 13" stroke="${color}" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 20C9 19 10.5 18.5 12 18.5C13.5 18.5 15 19 16 20" stroke="${color}" stroke-width="1.2" stroke-linecap="round"/></svg>`,
  ...
  mic: (color: string) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="9" y="3" width="6" height="12" rx="3" fill="${color}" opacity="0.18"/><rect x="9" y="3" width="6" height="12" rx="3" stroke="${color}" stroke-width="1.8"/><path d="M5 11C5 14.866 8.134 18 12 18C15.866 18 19 14.866 19 11" stroke="${color}" stroke-width="1.8" stroke-linecap="round"/><path d="M12 18V22M9 22H15" stroke="${color}" stroke-width="1.8" stroke-linecap="round"/></svg>`,
...
export function IconMic({ size = 24, color = '#fff', className = '' }: IconProps) {
  return <Image className={className} style={{ width: `${size}px`, height: `${size}px` }} src={svgToDataUri(svgs.mic(color))} />
}
