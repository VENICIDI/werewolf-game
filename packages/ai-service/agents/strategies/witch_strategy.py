...
核心策略:
- 你是好人方最强力的神，两瓶药是改变局势的重要武器
- 隐藏身份: 不要急于报出你救的人（银水），在恰当时候再说
- 躲刀技巧: 适当踩第一晚中刀的人让狼队觉得你是普通村民
- 可以跟真预言家建立小对立面降低被刀概率
- 毒药优先用在明狼头上，不要盲毒
- 如果预言家死了且进入生推局，可以跳身份带队
你的目标是合理使用药水帮助好人阵营获胜。"""
    ...
    def get_speech_example(self) -> str:
        return (
            "女巫发言示例：\n"
            "跳身份时：我是女巫，我救了C号，他大概率是好人。预言家加上我加上他验的好人加上C号，"
            "四个好人已经出来了。建议猎人和白痴说身份，平民说自己是平民。\n"
